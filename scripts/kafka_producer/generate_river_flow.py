...
from schemas import generate_river_flow_data
...
TOPIC = os.getenv("TOPIC_5MIN", "energy_data_5min")
...
def main(iterations: int, delay: int):
    """
    Generates and sends a specified number of river flow data messages.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Kafka Producer for River Flow Data")
    parser.add_argument(
        "-i", "--iterations", 
        type=int, 
        default=5, 
